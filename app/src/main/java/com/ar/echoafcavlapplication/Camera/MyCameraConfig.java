...
public class MyCameraConfig {
    ...
    public MyCameraConfig() {
        // Do nothing
    }

    public MyCameraConfig.Builder getBuilder(Context context) {
        mContext = context;
        return new MyCameraConfig.Builder();
    }
    ...
    public class Builder {
         ...
         * @return {@link CameraConfig.Builder}
         * @see CameraResolution
         */
        public MyCameraConfig.Builder setCameraResolution(@CameraResolution.SupportedResolution int resolution) {
         ...
         * @see CameraFacing
         */
        public MyCameraConfig.Builder setCameraFacing(@CameraFacing.SupportedCameraFacing int cameraFacing) {
            //Validate input
         ...
         * @see CameraFacing
         */
        public MyCameraConfig.Builder setCameraFocus(@CameraFocus.SupportedCameraFocus int focusMode) {
            //Validate input
         ...
         * @return {@link MyCameraConfig.Builder}
         * @see CameraImageFormat
         */
        public MyCameraConfig.Builder setImageFormat(@CameraImageFormat.SupportedImageFormat int imageFormat) {
            //Validate input
         ...
         * @see CameraRotation
         */
        public MyCameraConfig.Builder setImageRotation(@CameraRotation.SupportedRotation int rotation) {
            //Validate input
         ...
         * @return {@link MyCameraConfig.Builder}
         */
        public MyCameraConfig.Builder setImageFile(File imageFile) {
        ...
        private File getDefaultStorageFile() {
            return new File(MyHiddenCameraUtils.getCacheDir(mContext).getAbsolutePath()
                    + File.separator
