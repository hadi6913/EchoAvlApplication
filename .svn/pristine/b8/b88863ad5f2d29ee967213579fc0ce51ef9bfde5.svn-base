...
class MyCameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    MyCameraPreview(@NonNull Context context, MyCameraCallbacks cameraCallbacks) {
        super(context);
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i1, int i2) {
        ...
        //Sort descending
        Collections.sort(pictureSizes, new MyPictureSizeComparator());
     ...
     */
    void startCameraInternal(@NonNull MyCameraConfig cameraConfig) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (mCameraConfig.getImageRotation() != CameraRotation.ROTATION_0) {
                                rotatedBitmap = MyHiddenCameraUtils.rotateBitmap(bitmap, mCameraConfig.getImageRotation());
                            ...
                            if (MyHiddenCameraUtils.saveImageFromFile(rotatedBitmap,
